    ...
    <style>
        ...
        #modal-withdraw_alert_2hrs,#modal-withdraw_submit{
            padding: 200px 100px;
        }
        #modal-withdraw_alert_2hrs .modal-content,#modal-withdraw_submit .modal-content{
            background: #393E46;
            border: 4px solid #B4BAC8;
            box-sizing: border-box;
            border-radius: 10px;
        ...
        #modal-withdraw_alert_2hrs .modal-header,#modal-withdraw_submit .modal-header{
            border-bottom: none;
        }
        #modal-withdraw_alert_2hrs .modal-footer,#modal-withdraw_submit .modal-footer{
            border-top: none;
        }
        #modal-withdraw_alert_2hrs .btn_alert{
            background: #1072BA;
            box-shadow: 4px 4px 4px rgba(0, 0, 0, 0.25);
            border-radius: 10px;
            width: 150px;
        ...
        #modal-withdraw_alert_success,#modal-withdraw_submit{
            padding: 200px 100px;
        }
        #modal-withdraw_alert_success .modal-content,#modal-withdraw_submit .modal-content{
            background: #393E46;
            border: 4px solid #B4BAC8;
            box-sizing: border-box;
            border-radius: 10px;
        ...
        #modal-withdraw_alert_success .modal-header,#modal-withdraw_submit .modal-header{
            border-bottom: none;
        }
        #modal-withdraw_alert_success .modal-footer,#modal-withdraw_submit .modal-footer{
            border-top: none;
        }
        #modal-withdraw_alert_success .btn_alert{
            background: #1072BA;
            box-shadow: 4px 4px 4px rgba(0, 0, 0, 0.25);
            border-radius: 10px;
            width: 150px;
