...
<?php
    ...
    $scriptjs = array(
        ...
        "assets/js/admin/candle_chart_eth.js",
        "assets/js/admin/betting_eth.js",
                ...
                <div class="betting_field">
                    <table class="betting_table">
                        ...
                        <tr>
                            ...
                            <td class="lchild">ETH/USD 1분</td>
                        </tr>
                        <tr>
                            <td class="fchild">실현실격</td>
                            <td class="lchild"><img src="assets/icons/ic_baseline-plus-minus.png"> 0.2 USD</td>
                        </tr>
                        <tr>
